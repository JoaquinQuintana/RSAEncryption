...
def main():
    ...
    if userInput == '1':
        ...
        n = int(input("Enter the number you wish to find factors for: "))       
        RSAFunctions.bruteForceFactor(n)
    else:
        print("Exited script or one needs to read instructions closer, i.e., please enter type integer between 1-5")
